let palavras = ["abelha","cachorro", "gato", "galinha", "aranha", "andorinha", "borboleta", "canguru", "camelo", "cavalo", "carneiro", "coala", "elefante", "esquilo"];
...
if (acertou === false) {
    ...
    document.getElementById("forca").src = "img/forca-"+imagem+".jpg";
